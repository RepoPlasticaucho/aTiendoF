...
export class CategoriasService {
  ...
  obtenerCategoriasPro(proveedor: ProveedoresEntity): Observable<Categorias> {
    return this.http.post<Categorias>(`${environment.apiUrl}categorias/ObtenerCategoriasPro`, proveedor );
  }
