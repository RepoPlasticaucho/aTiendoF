...
@Component({
  selector: 'app-portafolios-dev',
  templateUrl: './portafolios-dev.component.html',
  styleUrls: ['./portafolios-dev.component.css']
})
export class PortafoliosDevComponent implements OnInit {
  searchText: string = '';
  ...
  comprar(modeloproducto: ModeloProductosEntity) {
    ...
    this.router.navigate(['/navegation-cl', { outlets: { 'contentClient': ['portafolios-comprar-dev'] } }]);
  }
