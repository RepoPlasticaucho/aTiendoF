...
@Component({
  selector: 'app-vistamarcas-dev',
  templateUrl: './vistamarcas-dev.component.html',
  styleUrls: ['./vistamarcas-dev.component.css']
})
export class VistamarcasDevComponent implements OnInit {
